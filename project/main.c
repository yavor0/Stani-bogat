...
struct question_t questions[] = {
	...
	{"Which sort of animal is Walt Disney's Dumbo?", "Elephant", "Deer", "Donkey", "Lion", 1,1},	
	...
	{" What do eagles usually eat?", "Fruit", "Meat", "Worms", "Leaves", 3,1},	
	{"In the children’s book series, where is Paddington Bear originally from?", "Iceland", "Peru", "India", "Canada", 2,2},
	{"Which animal is the tallest?", "Giraffe", "Lion", "Horse", "Cat", 1,0},	
	{"Which letter must appear on the beginning of the registration number of all non-military aircraft in the US?", "A", "U", "L", "N", 4,2},
	{"Which first lady was a ninth-generation descendant of Pocahontas?", "Edith Wilson", "Helen Taft", "Bess Truman", "Mamie Eisenhower", 1,1},	
	...
	{"Khrushchev's famous 1960 shoe-banging outburst at the UN was in response to a delegate from which nation?", "Austria", "The Philippines", "Turkey", "Spain", 3,2},	
	{"Where did Scotch whisky originate?", "Belgium", "Spain", "Ireland", "Wales", 3,0},
	{"When was Henry VIII born?", "28th June 1491", "4th July 1478", "6th January 1490", "12th February 1468", 2,2},
	...
	{"Nadia Comaneci was the first gymnast to ever do what at the Olympics?", "Get a perfect 10", "Get an injury", "Win an Olympic gold medal", "Forfeit her position", 1,1},
	...
	{"The national flag of which of these countries does not feature three horizontal stripes?", "Russia", "Germany", "Romania", "Bulgaria", 3,1},
	...
	{"On September 14, 2013, Floyd Mayweather must defend his WBA title against which boxer?", "Juan Manuel Márquez", "Canelo Alvarez", "José Luis Castillo", "Felipe Garcia", 2,2},
	...
	{"Which of these brands was chiefly associated with the manufacture of household locks?", "Phillips", "Ronseal", "Chubb", "Flymo", 3,1},
	{"Obstetrics is a branch of medicine particularly concerned with what?","Childbirth", "Broken bones", "Heart conditions", "Old age", 1,1},
	{"What does the word loquacious mean?", "Angry", "Chatty", "Beautiful", "Shy", 2,1},
	{"At the closest point, which island group is only 50 miles south-east of the coast of Florida?", "Bahamas", "US Virgin Islands", "Turks and Caicos Islands", "Bermuda", 1,2},
	{"The famous bulgarian influencer Stoyan Kolev is from which bulgarian city?", "Burgas", "Sofia", "Varna", "Plovdiv", 1,0},
	{"After the suspension of Slavi's show, on BTV comes a brand new show with a new host. What is the origin of the new host of the show?", "Bulgarian", "Greek", "American", "Italian", 2,0},
